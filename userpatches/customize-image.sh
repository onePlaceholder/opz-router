...
cp ./router-config /usr/local/bin
chown root:root /usr/local/bin/router-config
chmod 755 /usr/local/bin/router-config

# Install Initializer
cp ./init-router /etc/init.d/
chmod +x /etc/init.d/init-router 
update-rc.d init-router defaults
